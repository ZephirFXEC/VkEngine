...
namespace vke {
VkEngineWindow::VkEngineWindow(const int width, const int height,
                               std::string name)
...
void VkEngineWindow::createWindowSurface(const VkInstance instance,
...
void VkEngineWindow::framebufferResizeCallback(GLFWwindow* window,
                                               const int width,
                                               const int height) {
