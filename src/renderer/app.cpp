...
void App::loadGameObjects() {
	...
	const std::shared_ptr pVkModel = VkEngineModel::createModelFromFile(mVkDevice, "C:/Users/zphrfx/Desktop/vkEngine/obj/flat_vase.obj");
	...
	game_objects.mTransform.scale = glm::vec3(3.f);
